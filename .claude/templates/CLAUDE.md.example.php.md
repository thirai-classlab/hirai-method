...
> **本 file は `install.sh` が manifest 検出 (lang=php) 後に auto-fill 生成した starter です。**
...
- **Language / Framework**: PHP{{FRAMEWORK_LINE}}
- **Runtime**: {{RUNTIME_LINE}}
- **Package Manager**: composer
- **DB**: <!-- TODO(auto-fill): 例 MySQL / PostgreSQL / SQLite -->
- **Auth**: <!-- TODO(auto-fill): 例 Laravel Sanctum / Symfony Security / passport -->
- **Hosting**: <!-- TODO(auto-fill): 例 AWS / Render / bare metal / Cloudflare -->
- **AI / 外部 API**: <!-- TODO(auto-fill): 例 OpenAI SDK, Stripe -->

## Architecture / Data

<!-- TODO(auto-fill): レイアウト / MVC 構成 / docs リンク (例: docs/architecture.md) -->
