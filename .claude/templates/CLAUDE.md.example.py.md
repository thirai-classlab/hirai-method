...
> **本 file は `install.sh` が manifest 検出 (lang=py) 後に auto-fill 生成した starter です。**
...
- **Language / Framework**: Python{{FRAMEWORK_LINE}}
- **Runtime**: {{RUNTIME_LINE}}
- **Package Manager**: <!-- TODO(auto-fill): 例 uv / poetry / pip + venv / rye -->
- **DB**: <!-- TODO(auto-fill): 例 PostgreSQL / MySQL / SQLite -->
- **Auth**: <!-- TODO(auto-fill): 例 django-allauth / Authlib / FastAPI-Users -->
- **Hosting**: <!-- TODO(auto-fill): 例 AWS / GCP / Render / Fly.io -->
- **AI / 外部 API**: <!-- TODO(auto-fill): 例 OpenAI, Anthropic, LangChain -->

## Architecture / Data

<!-- TODO(auto-fill): レイアウト / 主要フロー / docs リンク (例: docs/architecture.md) -->
