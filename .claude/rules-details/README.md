...
|---|---|---|---|
| workflow | `workflow/` | (Step 2 で 14-stage / 10-stage / workflow-guard / draft-flow-guard / refactoring / mece-20 / fan-out / reviewer-prompt / byproduct-discharge / session-persistence 等) | 🔲 |
