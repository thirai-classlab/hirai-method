...
| 9 | 🔲 | harness-audit-followups | /harness-audit 観察候補の改修: (1) F3 confidence-gate agent_type allowlist + sidechain fail-open (96 件 regex_no_match 解消) + (2) autonomous-action-guard Normal 分岐 log_bypass 条件付き呼出 (mode-switch bypass log 化)。W1-W4 = 1.4h (起案 2026-05-13、user 承認済 2026-05-13) | #6, #8 | [task-9-harness-audit-followups.md](task-9-harness-audit-followups.md) |
