...
| 12 | 🔲 | dual-mode-portability | hook 物理位置と PROJECT_ROOT 分離 + 11 hooks 統一更新 + settings.json 2 テンプレート + smoke/docs で user-level / project-level 両対応 (draft 承認済 @ 2026-05-13、W1-W4 = 1.8h、subagent 並列で実 10-15 分見込み) | #7, #10, #11 | [task-12-dual-mode-portability.md](task-12-dual-mode-portability.md) |
